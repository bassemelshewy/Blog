    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body wizard-content">
                <form class="form" method="POST" action="{{route('posts.update', $post->id)}}" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control @error('content') is-invalid @enderror"
                                        placeholder="Enter content here" required minlength="10">{{ old('content') ?? $post->content}}</textarea>
                                </div>
                                @error('content')
                                    <span class="input-group-text text-danger border-danger mt-5">
                                        <strong>{{ $message }}</strong>
